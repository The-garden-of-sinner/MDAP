...
class CrossDomainUserDataloader(AbstractDataLoader):
    def __init__(self, config, dataset, source_dataset, source_sampler, target_dataset, target_sampler,
        ...
        self.source_dataloader = UserDataLoader(config, source_dataset, source_sampler, shuffle=shuffle)
        config.update(config['target_domain'])
        config['LABEL_FIELD'] = target_dataset.label_field
        self.target_dataloader = UserDataLoader(config, target_dataset, target_sampler, shuffle=shuffle)
        ...
        self.dataset.source_domain_dataset = source_dataset
